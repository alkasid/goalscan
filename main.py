...
def generate_html(matches, run_date, total_analyzed):
    ...
    css = (
        ...
        ".plane-bg{position:absolute;bottom:0;right:0;width:170px;height:110px;opacity:0.18;pointer-events:none;z-index:0;}"
    ...
    live_script = '<script>\nconst PROXY=\'https://spring-hall-b29e.nwgir.workers.dev\';\nasync function updateLive(){\n  try{\n    var all=[].slice.call(document.querySelectorAll(\'.card[data-fid]\'));\n    var ids=all.map(function(c){return c.getAttribute(\'data-fid\');}).filter(Boolean);\n    if(!ids.length)return;\n    var fixtures=[];\n    for(var i=0;i<ids.length;i+=20){\n      var chunk=ids.slice(i,i+20).join(\'-\');\n      var r=await fetch(PROXY+\'?endpoint=fixtures&ids=\'+chunk);\n      if(!r.ok)continue;\n      var data=await r.json();\n      fixtures=fixtures.concat(data.response||[]);\n    }\n    fixtures.forEach(function(fix){\n      var fid=String(fix.fixture.id);\n      var card=document.querySelector(\'[data-fid="\'+fid+\'"]\');\n      if(!card)return;\n      var st=fix.fixture.status.short,min=fix.fixture.status.elapsed,hg=fix.goals.home,ag=fix.goals.away;\n      var b=card.querySelector(\'.live-score\');\n      if(!b)return;\n      var live=[\'1H\',\'2H\',\'ET\',\'P\'].indexOf(st)>=0,ht=st===\'HT\',ft=st===\'FT\';\n      if(live||ht||ft){b.style.display=\'inline-flex\';b.className=\'live-badge\'+(ht?\' ht\':ft?\' ft\':\'\');b.textContent=ft?\'FT\':ht?\'HT\':(min?min+"\'":st);}\n      if(hg!=null&&ag!=null){\n        var s=card.querySelector(\'[data-score]\');\n        if(s){s.textContent=hg+\' - \'+ag;s.style.display=\'block\';var v=card.querySelector(\'.vs\');if(v)v.style.display=\'none\';}\n        var ok=(hg===1&&ag===0)||(hg===0&&ag===1);\n        if(ok&&!card.classList.contains(\'scoring\')){card.classList.add(\'scoring\');var p=document.createElement(\'div\');p.className=\'plane-bg\';p.innerHTML=\'<svg xmlns=\\\'http://www.w3.org/2000/svg\\\' viewBox=\\\'0 0 200 120\\\'><defs><linearGradient id=\\\'sky\\\' x1=\\\'0\\\' y1=\\\'0\\\' x2=\\\'0\\\' y2=\\\'1\\\'><stop offset=\\\'0%\\\' stop-color=\\\'%230a1628\\\'/><stop offset=\\\'100%\\\' stop-color=\\\'%231e4080\\\'/></linearGradient><linearGradient id=\\\'fuselage\\\' x1=\\\'0\\\' y1=\\\'0\\\' x2=\\\'0\\\' y2=\\\'1\\\'><stop offset=\\\'0%\\\' stop-color=\\\'%23eaf6ff\\\'/><stop offset=\\\'50%\\\' stop-color=\\\'%23b8d8ee\\\'/><stop offset=\\\'100%\\\' stop-color=\\\'%236a9ab8\\\'/></linearGradient></defs><rect width=\\\'200\\\' height=\\\'120\\\' fill=\\\'url(%23sky)\\\'/><ellipse cx=\\\'105\\\' cy=\\\'62\\\' rx=\\\'72\\\' ry=\\\'13\\\' fill=\\\'url(%23fuselage)\\\'/><path d=\\\'M177 62 Q200 60 196 57 Q184 54 177 59 Z\\\' fill=\\\'%23cce8f8\\\'/><path d=\\\'M33 62 Q18 62 20 69 Q27 74 35 65 Z\\\' fill=\\\'%2390b8cc\\\'/><path d=\\\'M108 61 L93 33 L72 37 L87 61 Z\\\' fill=\\\'%23bdd9ea\\\'/><path d=\\\'M108 63 L93 91 L72 87 L87 63 Z\\\' fill=\\\'%2399c0d5\\\'/><path d=\\\'M108 61 L93 33 L83 36 L95 61 Z\\\' fill=\\\'white\\\' opacity=\\\'0.3\\\'/><path d=\\\'M42 62 L49 40 L60 47 L56 62 Z\\\' fill=\\\'%23aacfe4\\\'/><ellipse cx=\\\'91\\\' cy=\\\'73\\\' rx=\\\'11\\\' ry=\\\'5\\\' fill=\\\'%236a8fa8\\\'/><ellipse cx=\\\'91\\\' cy=\\\'73\\\' rx=\\\'8\\\' ry=\\\'3\\\' fill=\\\'%234a6a80\\\'/><rect x=\\\'118\\\' y=\\\'55\\\' width=\\\'44\\\' height=\\\'7\\\' rx=\\\'3\\\' fill=\\\'%2300e5a0\\\' opacity=\\\'0.55\\\'/><ellipse cx=\\\'118\\\' cy=\\\'54\\\' rx=\\\'46\\\' ry=\\\'4\\\' fill=\\\'white\\\' opacity=\\\'0.2\\\'/><ellipse cx=\\\'32\\\' cy=\\\'63\\\' rx=\\\'7\\\' ry=\\\'2\\\' fill=\\\'%2300e5a0\\\' opacity=\\\'0.6\\\'/></svg>\';card.appendChild(p);}\n        else if(!ok){card.classList.remove(\'scoring\');var pl=card.querySelector(\'.plane-bg\');if(pl)pl.remove();}\n      }\n    });\n    var ts=document.getElementById(\'live-ts\');\n    if(ts)ts.textContent=\'\\ud83d\\udd04 \'+new Date().toLocaleTimeString();\n  }catch(e){console.log(\'live\',e);}\n}\nupdateLive();setInterval(updateLive,30000);\n</script>'
